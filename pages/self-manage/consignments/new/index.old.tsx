          ...
          <Body>
            ...
            <Box paddingY={4}>
              <Columns>
                <Column columnSpan={7}>
                  <Text>
                    Apply here to generate export documents. This includes
                    export permits and certificates and related documents as
                    required by importing countries. Refer to the Department of
